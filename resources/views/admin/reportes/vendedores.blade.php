            ...
            <div class="col-md-4">
                <div class="card shadow-sm border-left-warning">
                    <div class="card-body">
                        ...
                        <h2 class="mb-0">Bs. {{ number_format(array_sum(array_column($rendimientoVendedores, 'total_ventas')), 2) }}</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle mr-2"></i>No hay datos de vendedores para el período seleccionado.
                            </div>
                        @endif
                    </div>
                </div>
