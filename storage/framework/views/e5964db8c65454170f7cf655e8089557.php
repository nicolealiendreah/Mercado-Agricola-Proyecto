                        ...
                        <div class="card-body p-0">
                            <div class="position-relative"
                                ...
                                <div class="d-flex justify-content-center align-items-center" style="height: 400px;">
                                    <img id="mainImage" src="<?php echo e(asset('storage/' . $maquinaria->imagenes->first()->ruta)); ?>"
                            ...
                            <?php $__currentLoopData = $maquinaria->imagenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imagen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-4 mb-2">
                                    ...
                                    <div class="bg-white border rounded d-flex align-items-center justify-content-center"
                                        style="height: 90px;">
                                        <img src="<?php echo e(asset('storage/' . $imagen->ruta)); ?>" alt="Imagen <?php echo e($loop->iteration); ?>"
