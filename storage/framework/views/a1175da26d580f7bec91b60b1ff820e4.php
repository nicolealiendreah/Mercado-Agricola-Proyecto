                ...
                <div class="container">
                    ...
                    <div id="topnav" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white <?php echo e(request()->routeIs('ads.index') ? 'active' : ''); ?>"
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(auth()->user()->isVendedor() || auth()->user()->isAdmin()): ?>
                                    <li class="nav-item">
                                        <a class="nav-link text-white <?php echo e(request()->routeIs('admin.datos-sanitarios.*') ? 'active' : ''); ?>"
                                            href="<?php echo e(route('admin.datos-sanitarios.index')); ?>">
                                ...
                                <?php if(auth()->user()->isCliente()): ?>
                                    <li class="nav-item">
                                        <a class="nav-link text-white <?php echo e(request()->routeIs('solicitar-vendedor') ? 'active' : ''); ?>"
                                            href="<?php echo e(route('solicitar-vendedor')); ?>">
                                            <i class="fas fa-user-tie"></i> Ser Vendedor
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <li class="nav-item">
                                    <a class="nav-link text-white <?php echo e(request()->routeIs('cart.*') ? 'active' : ''); ?>"
                                        ...
                                        <?php if($cartCount > 0): ?>
                                            <span class="badge badge-danger badge-sm"
                                                id="cart-count"><?php echo e($cartCount); ?></span>
                                        <?php endif; ?>
                                    </a>
                                </li>
...
<?php /**PATH C:\Users\Nicole\proyecto\Proyecto-Agricola\resources\views/layouts/public.blade.php ENDPATH**/ ?>