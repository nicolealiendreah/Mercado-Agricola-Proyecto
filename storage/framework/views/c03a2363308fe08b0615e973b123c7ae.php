...
<div class="mb-3">
    <div class="bg-agro rounded-lg p-3 d-flex align-items-center text-white">
        ...
        <div class="ml-auto d-flex">
            ...
            <a href="<?php echo e(route('maquinarias.index')); ?>" class="btn btn-outline-light btn-sm">
                Ir a Maquinarias
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nicole\proy2\ProyectoAgricolaLocal\resources\views/organicos/index.blade.php ENDPATH**/ ?>