          ...
          <?php $__currentLoopData = $ganados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ganado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="card h-100 shadow-sm rounded-lg card-ad border-0">
                ...
                <?php endif; ?>
                <div class="card-body">
                  <h5 class="card-title mb-2"><?php echo e($ganado->nombre); ?></h5>
                  <ul class="ad-meta list-unstyled mb-2">
                    <?php if($ganado->ubicacion): ?>
                      <li><i class="fas fa-map-marker-alt text-muted"></i> <?php echo e($ganado->ubicacion); ?></li>
                    <?php endif; ?>
                    <?php if($ganado->tipoAnimal): ?>
                      <li><i class="fas fa-paw text-muted"></i> <?php echo e($ganado->tipoAnimal->nombre); ?></li>
                    <?php endif; ?>
                    <?php if($ganado->edad): ?>
                      <li><i class="fas fa-calendar text-muted"></i> <?php echo e($ganado->edad); ?> meses</li>
                    <?php endif; ?>
                  </ul>
                ...
                <div class="card-footer d-flex justify-content-between align-items-center bg-white border-top">
                  ...
                  <?php endif; ?>
                  <a href="<?php echo e(route('ganados.show', $ganado->id)); ?>" class="btn btn-success btn-sm px-3">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nicole\proy2\ProyectoAgricolaLocal\resources\views/public/ads/index.blade.php ENDPATH**/ ?>